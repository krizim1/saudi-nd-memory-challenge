...
```
backgrounds/   attract · gameplay · winner  (.webp, 1920×1080), on the guideline's
               #002628 grid ground. Registration and leaderboard reuse gameplay.webp.
cards/         the six traits' main icons and first secondary patterns, square
               800×800 .webp, cropped from the National Day 96 guideline (§5.2).
               The card back is drawn in code; add card-back.webp to override it.
logos/         logo.png — the official «عزّنا بطبعنا» artistic logo (guideline §1.2)
patterns/      najdi.svg (faint texture under the backgrounds)
